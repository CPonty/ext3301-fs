...
enum {
	Opt_crypter, Opt_bsd_df, Opt_minix_df, Opt_grpid, Opt_nogrpid,
...
MODULE_AUTHOR("Chris Ponticello, Remy Card and others");
MODULE_DESCRIPTION("Second Extended Filesystem (comp3301)");
MODULE_LICENSE("GPL");
